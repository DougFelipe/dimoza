...
extern int yylineno;
extern char *yytext;
extern FILE *yyin, *yyout; // Ponteiro para o arquivo de saída

// Função auxiliar para concatenar múltiplas strings
char *cat(const char *s1, const char *s2, const char *s3, const char *s4, const char *s5);
// Função para mapear tipos da nossa linguagem para tipos C
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_ARROW_LEFT = 8,                 /* ARROW_LEFT  */
...
{
       0,    51,    51,    61,    62,    73,    90,    91,    94,    95,
     105,   116,   117,   128,   129,   130,   131,   132,   136,   144,
     165,   175,   185,   196,   206,   207,   208,   212,   213,   214,
     215,   216,   217,   218,   219,   220,   224,   234,   235,   238,
     239
};
#endif
...
static const char *const yytname[] =
{
  ...
  "PRINT", "RETURN", "ARROW_LEFT", "SEMICOLON", "LPAREN", "RPAREN",
  "LBRACE", "RBRACE", "COMMA", "PLUS", "MINUS", "MUL", "DIV", "ID",
  "INT_LIT", "FLOAT_LIT", "$accept", "program", "decl_list", "func_decl",
  "param_list_opt", "param_list", "param", "stmt_list", "stmt",
  "var_decl_stmt", "assignment_stmt", "func_call_stmt", "print_stmt",
  "return_stmt", "type", "expr", "func_call", "arg_list_opt", "arg_list", YY_NULLPTR
};
...
{
      12,   -24,   -24,   -24,    10,    12,   -24,    11,   -24,   -24,
      36,    12,    37,    44,   -24,    40,    48,    12,   -24,   -24,
     -24,     1,     2,     2,   -24,    21,   -24,   -24,   -24,   -24,
     -24,   -24,    51,    60,     2,    61,   -24,   -24,    19,   -24,
      23,     2,     2,    -7,   -24,    46,   -24,     2,     2,     2,
       2,   -24,    34,    50,    62,    58,     2,   -24,   -24,    27,
      27,   -24,   -24,   -24,   -24,     2,    38,    50,   -24
};
...
{
     -24,   -24,   -24,    69,   -24,   -24,    59,   -24,   -24,   -24,
     -24,   -24,   -24,   -24,    -8,   -23,    54,   -24,   -24
};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] =
{
       0,     4,     5,     6,    12,    13,    14,    21,    26,    27,
      28,    29,    30,    31,     7,    38,    39,    54,    55
};
...
{
      40,    56,    57,    15,     1,     2,     3,    22,    23,    15,
       8,    45,    34,    32,    24,     1,     2,     3,    52,    53,
      25,    35,    36,    37,    59,    60,    61,    62,    46,    41,
      10,    42,    51,    66,    47,    48,    49,    50,    47,    48,
      49,    50,    67,    63,    49,    50,    11,    68,    16,    47,
      48,    49,    50,    47,    48,    49,    50,    58,    17,    18,
      19,    47,    48,    49,    50,    47,    48,    49,    50,    44,
      43,    42,    65,    64,     9,    33,    20
};

static const yytype_int8 yycheck[] =
{
      23,     8,     9,    11,     3,     4,     5,     6,     7,    17,
       0,    34,    10,    21,    13,     3,     4,     5,    41,    42,
      19,    19,    20,    21,    47,    48,    49,    50,     9,     8,
      19,    10,     9,    56,    15,    16,    17,    18,    15,    16,
      17,    18,    65,     9,    17,    18,    10,     9,    11,    15,
      16,    17,    18,    15,    16,    17,    18,    11,    14,    19,
      12,    15,    16,    17,    18,    15,    16,    17,    18,     9,
      19,    10,    14,    11,     5,    21,    17
};
...
{
       0,     3,     4,     5,    23,    24,    25,    36,     0,    25,
      19,    10,    26,    27,    28,    36,    11,    14,    19,    12,
      28,    29,     6,     7,    13,    19,    30,    31,    32,    33,
      34,    35,    36,    38,    10,    19,    20,    21,    37,    38,
      37,     8,    10,    19,     9,    37,     9,    15,    16,    17,
      18,     9,    37,    37,    39,    40,     8,     9,    11,    37,
      37,    37,    37,     9,    11,    14,    37,    37,     9
};
...
#line 74 "parser.y"
           {
               const char* c_return_type = strcmp((yyvsp[-6].str_val), "main") == 0 ? "int" : map_type((yyvsp[-7].rec)->code);
               
               char *s1 = cat((char*)c_return_type, " ", (yyvsp[-6].str_val), "(", (yyvsp[-4].rec)->code);
               char *s2 = cat(s1, ")\n{\n", (yyvsp[-1].rec)->code, "}\n", "");
...
#line 145 "parser.y"
               {
                   ...
                   /* BLOCO CORRIGIDO                */
                   /**************************************************/
                   // Passo 1: Concatena a primeira parte da string
                   char* part1 = cat("\t", (yyvsp[-4].rec)->code, " ", (yyvsp[-3].str_val), " = ");
                   // Passo 2: Concatena o resultado com o resto, incluindo o ponto e vírgula
                   char* s = cat(part1, (yyvsp[-1].rec)->code, ";", "", "");
                   (yyval.rec) = createRecord(s, "");
                   
                   // Libera toda a memória intermediária alocada
                   free(part1);
                   free(s);
                   freeRecord((yyvsp[-4].rec));
...
#line 186 "parser.y"
            {
                const char* format = strcmp((yyvsp[-1].rec)->opt1, "Float") == 0 ? "%f" : "%d";
...
#line 1438 "y.tab.c"
  ...
  case 32: /* expr: ID  */
#line 217 "parser.y"
                  { (yyval.rec) = createRecord((yyvsp[0].str_val), "ID"); free((yyvsp[0].str_val)); }
#line 1444 "y.tab.c"
    break;

  case 33: /* expr: INT_LIT  */
#line 218 "parser.y"
                  { char buf[32]; sprintf(buf, "%d", (yyvsp[0].int_val)); (yyval.rec) = createRecord(strdup(buf), "Int"); }
#line 1450 "y.tab.c"
    break;

  case 34: /* expr: FLOAT_LIT  */
#line 219 "parser.y"
                  { char buf[32]; sprintf(buf, "%f", (yyvsp[0].float_val)); (yyval.rec) = createRecord(strdup(buf), "Float"); }
#line 1456 "y.tab.c"
    break;
...
/* Função para concatenar até 5 strings */
char* cat(const char *s1, const char *s2, const char *s3, const char *s4, const char *s5) {
...
/* Mapeia tipos da linguagem para C */
const char* map_type(const char* original_type) {
...
/* Função 'main' que gerencia os arquivos de entrada/saída */
